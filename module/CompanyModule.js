...
module.exports = {
    ...
    saveCompanyData: (data, user_name) => {
        return new Promise(async (resolve, reject) => {
            ...
            no_of_user = '${data.no_of_user}', amc_start = '${data.amc_start}', 
            amc_end = '${data.amc_end}', active_flag = '${data.active_flag ? data.active_flag : "Y"}', modified_by = '${user_name}', modified_dt = '${datetime}'` : 
            ...
            '${data.phone_no}', '${data.email}', '${data.no_of_mechine}', '${data.no_of_user}','${data.amc_start}', 
